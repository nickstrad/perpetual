...
Start here before investigating or changing the repository.
This index describes every file and folder within `docs/knowledge/`.
Follow [README.md](README.md) when adding or maintaining entries.

| Path | Contents |
| --- | --- |
| [./](./) | Project knowledge collection; organization rules and durable findings |
...
| [durable-registration.md](durable-registration.md) | Registration gate and commit uncertainty, startup snapshot ordering, replay, and owned Docker fixture boundaries |
